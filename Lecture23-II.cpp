// Lecture 23 II - Greedy Algorithms II Pt 2

#include <iostream>
using namespace std;

void printmaxclassesattend(int start[], int end[], int class_id[]){
    cout << "The clases which you should attend to cover maximum of them (hopefully you do) : " << endl;
    cout << class_id[0];

    int end_of_class_currently_attending = end[0];
